-- CREATE DB
CREATE DATABASE IF NOT EXISTS mseet_33726398_siakad;
USE mseet_33726398_siakad;

DROP TABLE IF EXISTS user_auth;
DROP TABLE IF EXISTS students_data;

-- USER SIGNUP/SIGNIN
CREATE TABLE IF NOT EXISTS mseet_33726398_siakad.user_auth(
...
INSERT INTO mseet_33726398_siakad.user_auth VALUE(
    "admin", 
    "Admin", 
    "SIAKAD", 
    "082281190072", 
...
-- USER STUDENT DATA
CREATE TABLE IF NOT EXISTS mseet_33726398_siakad.students_data (
...
INSERT INTO mseet_33726398_siakad.students_data VALUES
