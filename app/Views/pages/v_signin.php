...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <?php echo form_open('auth/checklog'); ?>
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="username" type="text" class="form-control" placeholder="Username" value="<?php echo $username = session()->getFlashdata('username'); ?>">
                ...
                <div class="input-group mb-3">
                    ...
                    <input id="passInput" name="password" type="password" class="form-control" placeholder="Password" value="<?php echo $password = session()->getFlashdata('password'); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-4 ">
                        <button id="RegisterBtn" type="submit" class="btn btn-primary btn-block" onclick="">Login</button>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- </form> -->
                ...
                <div class="login-box-footer-msg d-flex justify-content-center">
                    <a href="<?= 'signup' ?>" class="text-center">Have no account? (Signup)</a>
                </div>
            </div>
